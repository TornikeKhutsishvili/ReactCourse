    ...
    <div className="todo-done-container my-4">
      <div className="container">
        <div className="card shadow-sm border-0 rounded-3">
          <div className="card-header fw-bold todo-done-header">
            {translations.todoDone.Done} | {done.length}
          </div>
                ...
                {done.length > 0 ? (
                    ...
                    >
                      ...
                      <td className="text-end w-100">
                        ...
                        >
                          {translations.todoDone.BackToTodo}
                        </button>
                  ...
                  <tr>
                    <td colSpan="2" className="text-center text-muted">
                      {translations.todoDone.NoCompletedTasks}
                    </td>
                  </tr>
                )}
              </tbody>
